...
if(isset($_POST['btn_search']) && ($_POST['search_status'] !== 'all')){
    $status = $_POST['search_status'];

    $tasks_result = $task->searchStatus($user_id, $status);
}else{
    $tasks_result = $task->getallUserTasks($user_id);
...
<div  class="container-fluid">
    ...
    <main class="h-100 w-75 mx-auto mt-5">
        <h1 class="text-center">ALL YOUR TASKS</h1>
        ...
        <div class="row mb-2">
            ...
            <div class="col-6">
                <div class="row">
                    <div class="col-8">
                        <select class="form-select" name="search_status" id="">  
                    ...
                    <div class="col-4">
                        <button type="submit" name="btn_search" class="btn btn-secondary w-100">SEARCH</button>      
                    </div>
                </div>        
            </div>
        </div>
