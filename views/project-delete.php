...
<body>
    ...
    <div class="card-header bg-white border-0">
        <h2 class="card-title text-center text-danger h4 mb-0">Delete Project</h2>
    </div>
    ...
    <div class="card-body">
        <div class="text-center mb-4">
            ...
            <p class="fw-bold mb-0">Are you sure you want to delete "<?= $project_row['project_name'] ?>"</p>
       ...
       <div class="row">
           ...
           <div class="col">
               <form action="../actions/project.php?project_id=<?= $project_id ?>" method="post">
                   <button type="submit" class="btn btn-outline-danger w-100" name="btn_project_delete">Delete</button>
               </form>
           </div>
       </div>
    </div>
