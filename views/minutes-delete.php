...
$minutes = new Minutes;
$minutes_result = $minutes->getMinutes($minutes_id);
...
<body>
    ...
    <div class="card-header bg-white border-0">
        <h2 class="card-title text-center text-danger h4 mb-0">Delete Minutes</h2>
    </div>
    ...
    <div class="card-body">
        <div class="text-center mb-4">
            ...
            <p class="fw-bold mb-0">Are you sure you want to delete "<?= $minutes_row['title'] ?>"</p>
    
       </div>

       <div class="row">
           <div class="col">
               <a href="project-view.php" class="btn btn-secondary w-100">Cancel</a>
           </div>
           <div class="col">
               <form action="../actions/minutes.php?minutes_id=<?= $minutes_id ?>" method="post">
                   <button type="submit" class="btn btn-outline-danger w-100" name="btn_minutes_delete">Delete</button>
               </form>
           </div>
       </div>
    </div>
